...
public class LDACompute {
	...
	public LDACompute(String testFilePath, int topics, double alphaSum, double beta) throws IOException {
		traininglist = InstancesReader.getInstances(testFilePath);
		if (topics != 0)
			this.numTopics = topics;
	 ...
	 * @return training data
	 */
	public InstanceList getTrainlist(){
		return traininglist;
	}
	...
	public List<String> getLabels(){
		...
		for(Instance i:traininglist){
			list.add(i.getTarget().toString());
		}
		return list;
	}
	...
	public static void main(String[] args) throws IOException {
		// TODO Auto-generated method stub
			...
			WriterUtils.write2file(result, "Result.txt");
		}
}